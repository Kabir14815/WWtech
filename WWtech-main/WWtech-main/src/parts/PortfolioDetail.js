          ...
          <div className="flex flex-col mt-8 justify-center">
            ...
            <Fade bottom delay={300 * 1} triggerOnce>
              <div className="flex flex-col mt-16 mb-12 mx-8 sm:mx-16 xl:mx-28">
                ...
                WeCure Wellness is a Gen-Z-focused wellness startup that combines AI technology and certified human experts to deliver personalized solutions for mental, emotional, and spiritual health. Our goal is to make holistic wellness accessible, affordable, and stigma-free through a digital-first approach.
              </p>
              </div>
              ...
              <p className="font-light italic text-gray-400 mt-16 mx-8 sm:mx-16 xl:mx-28">
                 This project is just one of our project.
                {' '}
                <br />
